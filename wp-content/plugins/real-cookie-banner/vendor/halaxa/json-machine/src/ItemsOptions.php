...
use DevOwl\RealCookieBanner\Vendor\JsonMachine\JsonDecoder\ItemDecoder;
/** @internal */
class ItemsOptions extends \ArrayObject
{
    ...
    private function validateOptions(array $options)
    {
        ...
        try {
            ...
            throw new InvalidArgumentException(\preg_replace('~Argument #[0-9]+~', "Option '{$optionName}'", $typeError->getMessage()));
        }
    }
    ...
    {
        return ['pointer' => '', 'decoder' => new ExtJsonDecoder(), 'debug' => \false];
    }
}
